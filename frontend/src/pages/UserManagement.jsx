...
import { Users, UserPlus, Trash2, Shield, Mail, ArrowLeft, X } from 'lucide-react';
...
export default function UserManagement() {
  ...
  const getDisplayName = (u) => u?.name?.trim() || u?.email || 'Unnamed User';
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-[var(--text-muted)] mt-1">
                Create, assign roles, and manage credentials for system users
              </p>
            </div>
                  ...
                  <tr key={userId || u.email || Math.random()}>
                    <td>
                      <div className="driver-avatar-cell">
                        ...
                        <div>
                          <div className="cell-bold">{getDisplayName(u)}</div>
                        </div>
                      </div>
                    </td>
                    <td>
